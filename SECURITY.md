...
- Injection attacks during JSON↔FTAI conversions
- Malformed `.ftai` documents causing CI or build failures

## Disclosure Policy
- We operate on a 90-day responsible disclosure policy.
